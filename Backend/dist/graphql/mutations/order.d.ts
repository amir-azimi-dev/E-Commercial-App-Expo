...
declare const placeOrder: (_: unknown, { orderItems, shoppingAddress1, shoppingAddress2, phone, city, zip, country }: PlaceOrderParams, context: any) => Promise<OrderDocument>;
